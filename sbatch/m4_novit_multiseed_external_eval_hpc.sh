#!/bin/bash
#SBATCH --job-name=PVT-M4-novit-ext-eval
...
#SBATCH --output=/pub/wonseukl/Path-ViT/.logs/m4_novit_multiseed_external_eval.log

# m4_novit_multiseed_kfold_array_hpc.sh(3seed x 5fold=15개 학습)가 저장해 둔 checkpoint
...
#
# 제출: sbatch sbatch/m4_novit_multiseed_external_eval_hpc.sh
