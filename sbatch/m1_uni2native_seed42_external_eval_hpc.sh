#!/bin/bash
#SBATCH --job-name=PVT-M1-uni2native-seed42-ext-eval
...
#SBATCH --output=/pub/wonseukl/Path-ViT/.logs/m1_uni2native_seed42_external_eval.log

# m1_uni2native_seed42_kfold_array_hpc.sh(seed42, 5fold 학습)가 저장해 둔 checkpoint 5개를
...
#
# 제출: sbatch sbatch/m1_uni2native_seed42_external_eval_hpc.sh
...
for ((FOLD=0; FOLD<N_FOLDS; FOLD++)); do
  mapfile -t MATCHES < <(ls models/checkpoint/survival_tcga_uni2native_seed${SEED}_*M1_uni2native_DISP_NOVIT_FOLD${FOLD}OF${N_FOLDS}_best.pt 2>/dev/null)
