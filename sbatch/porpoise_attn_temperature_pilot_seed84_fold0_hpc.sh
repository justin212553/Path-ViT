...
# 최적화"되는지 확인한다.
#
# no_aux 최종 레시피(dispersion 유지, aux 제거, seed84/fold0, baseline T=1.0 internal C=0.7119
# — 이미 확인된 값이라 재확인용 T=1.0은 뺌, 시간 절약)에 temperature만 3단계로 스윕 —
# array index 0/1/2 = T 0.5/0.2/0.1.
#
