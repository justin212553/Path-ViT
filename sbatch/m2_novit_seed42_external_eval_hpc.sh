#!/bin/bash
#SBATCH --job-name=PVT-M2-novit-seed42-ext-eval
...
#SBATCH --output=/pub/wonseukl/Path-ViT/.logs/m2_novit_seed42_external_eval.log

# m2_novit_seed42_kfold_array_hpc.sh(seed42, 5fold 학습)가 저장해 둔 checkpoint 5개를
...
#
# 제출: sbatch sbatch/m2_novit_seed42_external_eval_hpc.sh
...
for ((FOLD=0; FOLD<N_FOLDS; FOLD++)); do
  mapfile -t MATCHES < <(ls models/checkpoint/survival_tcga_uni2_seed${SEED}_*M2_uni2_STG_R_DISP_COX_ADD_NOVIT_FOLD${FOLD}OF${N_FOLDS}_best_clinical.pt 2>/dev/null)
