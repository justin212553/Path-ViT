...
HPC에서 이 스크립트까지 돌려서 무거운 256px 타일 JPG는 안 옮기고, 작은 feature/coords .pt
파일만 로컬로 받아오면 된다(scripts/zip_uni2official_features_for_hpc.py와 같은 관례로,
다 되면 zip 스크립트도 그대로 재사용 가능 — data/patch_utils.py의 파일명 상수만 바뀜).
