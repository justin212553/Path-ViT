    ...
    def __init__(self, cfg: ModelConfig, precomputed: bool = True, backbone: str = "resnet50",
        ...
        if skip_patch_vit:
            ...
            self.vit = ViTEncoder(cfg.embed_dim, cfg.num_heads,
                                  ...
                                  use_knn_mean_agg=getattr(cfg, "use_knn_mean_agg", False),
                                  use_cluster_attn=getattr(cfg, "use_cluster_attn", False),
                                  n_clusters=getattr(cfg, "n_clusters", 16),
                                  fix_nystrom_landmarks=getattr(cfg, "fix_nystrom_landmarks", False),
